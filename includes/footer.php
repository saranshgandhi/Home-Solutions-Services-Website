...
?>
              ...
              <li><span class="fa fa-phone"></span><a href="tel:+91-9724248726"> +<?php  echo $row['MobileNumber'];?></a></li>
              <li><span class="fa fa-envelope-open-o"></span><a href="mailto:saranshgandhi60@mail.com" class="mail">
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© 2024  Home Solutions </p>
